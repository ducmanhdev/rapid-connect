<template>
  <section class="card grow p-0">
    <div class="divide-y">
      ...
      <div class="divide-y divide-CE6 child:px-[30px] child:py-3.5">
        <div>
          <a-checkbox v-model:checked="value">Allow tax and fee to be removed from an order</a-checkbox>
        </div>
        <div class="!pl-[62px]">
          <p class="mb-0">Tax rates & Fees</p>
          <p class="mb-0 text-C82">0 Tax rates/fees added</p>
        </div>
      </div>
    </div>
  </section>
